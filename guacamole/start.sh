...
# Set up JWT auth
#
cp /guacamole/libs/* $GUACAMOLE_HOME/lib/
cp /guacamole/*.jar $GUACAMOLE_EXT/
echo -e "auth-provider:com.aiden0z.guacamole.net.jwt.JwtAuthenticationProvider\n
secret-key:\n" >> "$GUACAMOLE_PROPERTIES"
